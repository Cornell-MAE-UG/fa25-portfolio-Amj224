...
![Shaded rendering of earlier version]({{ "/assets/images/chord+twist_g.png" | relative_url }}){: .inline-image-r}
...
![Power vs RPM with Resisence]({{ "/assets/images/res_g.png" | relative_url }}){: .inline-image-c style="width: 400px"}
